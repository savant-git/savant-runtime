...
Organizes ordered evidence/events into narrative, causal and
milestone-oriented projections without converting interpretation into
source evidence.

## Verified provided capabilities

-   `causality.project` --- canonical capability token carried by the
    V15 candidate; final ownership must be reconciled against live
    Traits/Quirks.
-   `narrative.sequence` --- canonical capability token carried by the
    V15 candidate; final ownership must be reconciled against live
    Traits/Quirks.
-   `milestone.project` --- canonical capability token carried by the
    V15 candidate; final ownership must be reconciled against live
    Traits/Quirks.
...
Receives ordered events from Chron.
