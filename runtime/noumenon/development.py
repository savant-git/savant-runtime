...
def continuity_challenge(
    ...
    predecessor_lineage = set(
        predecessor.lineage_refs
    )

    successor_lineage = set(
        successor.lineage_refs
    )

    if not predecessor_lineage.issubset(
        successor_lineage
    ):
        failures.append(
