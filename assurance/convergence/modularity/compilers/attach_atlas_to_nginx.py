...
schema_version = "savant.assurance.attach-atlas-to-nginx.v4"
authority_effect = "none"

listen_port = 8765
atlas_port = 8776

atlas_marker_begin = "    # savant-atlas-begin\n"
atlas_marker_end = "    # savant-atlas-end\n"
...
def atlas_block_bounds(
    ...
    begin = text.find(atlas_marker_begin)
...
def build_migration(
    ...
    bounds = atlas_block_bounds(original)
...
def validate_atlas_block(
    ...
    bounds = atlas_block_bounds(text)
...
def main() -> int:
    ...
    try:
        result = migrate(arguments.apply)
