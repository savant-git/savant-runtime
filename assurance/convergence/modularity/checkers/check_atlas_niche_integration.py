...
schema_version = (
    "savant.assurance."
    "atlas-niche-integration-check.v2"
)
...
def check_frontend() -> dict[str, Any]:
    ...
    require_any(
        ...
        "Atlas stylesheet route is unavailable",
    )
    ...
    require_any(
        ...
        "Atlas JavaScript route is unavailable",
    )
...
def check_navigation() -> dict[str, Any]:
    ...
    require(
        "atlasRoute"
        in javascript,
        "Niche Atlas navigation route owner unavailable",
    )
    ...
    require(
        "atlasRoute"
        in javascript,
        "Niche Atlas navigation activation target unavailable",
    )
    ...
    return {
        "status":
            "passed",
        "javascript":
            str(navigation_js_path),
        "css":
            str(navigation_css_path),
    }
