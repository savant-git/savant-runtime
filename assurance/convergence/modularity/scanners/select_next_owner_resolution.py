...
schema = "savant.assurance.next-owner-resolution.v5"
...
def is_parked(
    ...
    return any(
        fragment in value
        for fragment in parked_path_fragments
    )
