...
Canonical edifice substance remains nested.
...
Segues govern transitions between edifice levels.
...
A Segue is a first-class governed transition between adjacent edifice levels.
A Segue:
...
never becomes a false edifice child.
Shared edifice infrastructure belongs under the correct level Segue.
The ontology root contains edifice roots only.
...
edifice substance remains nested.
