...
/**
 * savant / niche / atlas
 * awwwards site of the day spatial controller
 * build: atlas-2026.awwwards.master
...
(() => {
  ...
  const GEO = Object.freeze({ pad: 48, gap: 32, head: 76, inner: 24, taskW: 200, taskH: 52, minW: 460, minH: 300 });
  ...
  const state = {
    ...
    selected: null, focusTerritory: null, query: "",
