...
(() => {
  ...
  function bindControls() {
    dom.nav.addEventListener("click",open);dom.railToggle?.addEventListener("click",()=>setRailOpen(!state.railOpen));dom.fit.onclick=fitWorld;dom.local.onclick=()=>state.selected?focusTask(state.selected):state.focusTerritory?fitTerritory(state.focusTerritory):fitWorld();
