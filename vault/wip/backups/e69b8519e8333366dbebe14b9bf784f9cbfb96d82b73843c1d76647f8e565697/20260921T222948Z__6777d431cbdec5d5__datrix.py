...
schema = "savant.carbon.straub.datrix.v6"
owner = "carbon"
module = "straub"
...
class StraubDatrix:
    ...
    Optional capability modules describe composable
    behavior around that kernel. Module descriptors are
    deterministic, rebuildable, and non-authoritative.
