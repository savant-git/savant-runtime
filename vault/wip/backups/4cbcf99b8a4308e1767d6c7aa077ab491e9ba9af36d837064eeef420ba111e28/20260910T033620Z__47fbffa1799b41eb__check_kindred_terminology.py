...
schema = "savant.assurance.kindred-terminology-check.v4"
authority_effect = "none"

compiler_path = Path(
    "/root/savant-runtime/assurance/convergence/"
    "modularity/compilers/"
...
def load_compiler():
    ...
    module_name = (
        "savant_kindred_terminology_migration_v4"
    )
