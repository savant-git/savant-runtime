...
from guise_behavior import CharacterBehaviorEngine
from guise_blindspot import CharacterBlindSpotEngine
...
from guise_memory import CharacterMemoryLedger
...
from guise_reciprocity import ReciprocityEngine
from guise_relationship import (
    CharacterRelationshipEngine,
)
from guise_restraint import PredictiveRestraintEngine
...
class GuiseRuntime:
    def __init__(
        ...
        *,
        ...
        self.memory = CharacterMemoryLedger()
        self.relationship = CharacterRelationshipEngine()
        ...
        self.compare = CharacterComparator(self.guise)
        ...
        self.blindspot = CharacterBlindSpotEngine()
        self.restraint = PredictiveRestraintEngine()
        self.falsify = CharacterFalsifier()
        self.reconcile = MinimumDifferenceReconciler()
        self.continuity = GuiseContinuitySentinel()
        self.knowledge_leaks = KnowledgeLeakDetector()
    ...
    def health(self) -> dict[str, Any]:
        return {
            ...
            "provider_registry": self.providers.status(),
            "store": self.store.status(),
            "projection_index": self.projections.status(),
            "bitemporal_model": True,
            "memory_truth_separation": True,
            "relationship_conditioning": True,
            "reciprocity_feedback": True,
            "arc_graph": True,
            "narrative_debt": True,
            "scene_projection": True,
            "cross_character_comparison": True,
            "blind_spot_projection": True,
            "predictive_restraint": True,
            "falsification": True,
            "minimum_difference_reconciliation": True,
