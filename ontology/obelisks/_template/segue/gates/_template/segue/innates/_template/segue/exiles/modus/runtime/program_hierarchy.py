...
class ProgramHierarchySegue:
    segue_id: str
    parent_instance: str
    child_instance: str
    ordinal: int
    functional_role: str = "composition"
    semantic_axis: str = "program-hierarchy"
...
def make_program_hierarchy_segue(
    *,
    parent_instance: str,
    child_instance: str,
    ordinal: int,
) -> ProgramHierarchySegue:
    material = {
        "parent_instance": (
            parent_instance
        ),
