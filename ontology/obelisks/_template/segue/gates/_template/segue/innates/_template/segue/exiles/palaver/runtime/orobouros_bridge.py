...
def _load_package_compat() -> ModuleType:
    _ensure_package()
    ...
    if not package_compat_path.is_file():
        raise (
...
def _install_envoy_compatibility() -> dict[str, Any]:
    module = (
        _load_package_compat()
    )
