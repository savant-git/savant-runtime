...
schema = (
    ...
    "orobouros-enterprise-selftest/1.0.1"
)
...
def main() -> int:
    with tempfile.TemporaryDirectory(
        ...
        require(
            recovered_session
            is not None,
            "session did not survive store reopen",
        )
        ...
        require(
            ...
            "receipt history is not readable",
        )
        ...
        output = {
            ...
            "session_id":
                session_id,
            "session_creation_verified_by_reload":
                True,
            "restart_recovery":
                True,
            ...
            "deterministic_persona_replay":
                True,
            "deterministic_reflection_replay":
                True,
