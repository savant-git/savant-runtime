...
def project_route(
    ...
    *,
    ...
    """
    Project a deterministic analytical view of an Opus route.

    Registry material is read directly because this projection must
    remain independent of runtime provider selection, availability,
    policy binding, provider loading, and execution.

    opus.runtime.router remains authoritative for those operations.
    """
