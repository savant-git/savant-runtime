...
def _load_evidence_runtime():
    ...
    if not evidence_path.is_file():
        raise chat_outcome_capture_error(
            "conversation outcome evidence runtime is missing"
        )
    ...
    if (
        ...
        raise chat_outcome_capture_error(
            "unable to load conversation outcome evidence runtime"
        )
        ...
        if not session_id:
            return _fallback(
                ...
                metadata=
                    metadata_value,
                fallback_reason=
                    "session_identifier_unavailable",
            )
        ...
        if not request_id:
            return _fallback(
                ...
                metadata=
                    metadata_value,
                fallback_reason=
                    "request_identifier_unavailable",
            )
